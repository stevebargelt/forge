# Designer worker — extends agent-dev-worker with the Pencil CLI and the pencil-design
# Claude skill. Used by designer agents for UI/UX design tasks. Built separately so
# Pencil's deps don't bloat the default agent image.
#
