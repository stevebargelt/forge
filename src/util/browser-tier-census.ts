...
// still renders.
// FG-386 adds `fg386-shipping-audit` (5 tests): the read-only shipping-audit panel
...
// an open architecture question reading as needs-human on the review axis, and an
...
export const TIER_TESTS: Readonly<Record<string, number>> = {
  ...
  "fg386-shipping-audit.test.ts": 5,
