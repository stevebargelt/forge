...
export const TIER_TESTS: Readonly<Record<string, number>> = {
  ...
  // FG-781 adds `fg781-remote-board` (8 tests): the focused Remote Board client renders the
  // five projection states honestly in a real browser — the live board, a stale board marked
  // explicitly NOT live (a live→stale Refresh flip that never leaves a residual live marker),
