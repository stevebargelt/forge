...
`,
  ...
  // there is no flat dispatch fallback, so the positive test's startCampaign/resume
  // dispatch refuses without a published generation. Called after ensureRuntime in
  // beforeEach, so this captures both.
