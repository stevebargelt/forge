...
const RESTORE_CONTRACT = [
  ...
  "     are left byte-for-byte untouched. In the residual case of a store carrying an",
  "     un-checkpointed WAL from a prior non-clean shutdown, a mid-swap crash may",
  "     discard that WAL tail; it is always recoverable from the pre-restore safety",
