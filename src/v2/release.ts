...
export function renderEntry(interpreter: string): string {
  ...
  return [
    ...
    "# Plain one-arg readlink (no -f, no --) is the only portable form — both are GNU",
    "# extensions the BSD/macOS readlink lacks; a leading-dash path is disarmed with a",
    "# ./ prefix instead of --.",
    `p=$0`,
